...
export const POST: RequestHandler = async ({ request }) => {
	try {
		...
		Besides potions and spells; health and mana can only be replenished by having time in tavern. For example sleeping, eating and drinking, chatting with people etc. Player can't just ask for "heal myself" or "fill my health points" type of conversion. If player tries that, alert the player using @story.
