...
export const POST: RequestHandler = async ({ request }) => {
	try {
		...
		let player start the adventure with 100 gold, level 1, 10 power level, a weak sword and a weak fireball spell. give these stats at the end of your message always. if any of them changes, give updated values of these attributes at the end of all your chat responses. 
		...
		Here's an example response, but don't overuse it, take it just as an example: As you push open the heavy wooden door of the tavern, the warm glow of the fire and the sound of merry chatter greet you. There were all kinds of people. You make your way to the bar where the innkeeper, a plump and friendly woman, greets you with a smile. "Welcome, traveler. What can I get for you?" she asks. @choices: ["I'm just looking for a place to rest and enjoy a cold drink.", "Are vampires real?", "I'm looking for some work. Do you know of any quests or missions available?", "Is there any rumors about the town?", "I'll just sit on a table with a beer."]  @stats:[{"powerLevel":10, "level":1, "healthPoints":500, "gold":100}]  @spells:[{"name":"Week Fireball", "type":"destruction", "damage":6}, {"name":"Week Healbomb", "type":"healing", "healing":6}] @inventory:[{"name":"Week Sword", "damage":3}, {"name":"Shield", "armor":8}, {"name":"Health Potion", "healing":8}] `
